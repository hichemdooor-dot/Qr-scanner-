...
function menuHTML(){
  ...
  return `<div class="nav dash-menu">
    ...
    <a href="maintenance.html">${icon('<path d="M14 6a4 4 0 0 0 4.8 4.8L12 17.6 9.4 15 16.2 8A4 4 0 0 0 14 6z"/><path d="M8 16l-3 3"/>')}<span>Maintenance / Alertes</span></a>
    <a href="chariots.html">${icon('<rect x="4" y="4" width="16" height="16" rx="2"/><circle cx="9" cy="9" r="1.5"/><path d="M6 17l4-4 3 3 2-2 3 3"/>')}<span>Photos / Documents</span></a>
    <a href="gestion.html">${icon('<circle cx="9" cy="8" r="3"/><path d="M3 20c0-3.3 2.7-5 6-5s6 1.7 6 5"/><path d="M17 11a3 3 0 1 0 0-6M17 15c2.4 0 4 1.5 4 4"/>')}<span>Gestion utilisateurs</span></a>
